...
class GenerateCodeDialog(QtWidgets.QDialog):
    def __init__(self, parent=None):
        ...
        self.checkBoxMotionControl.setText("力矩/运动控制")
        ...
        self.checkBoxPidVel.setText("速度PID")
        ...
        self.checkBoxPidAngle.setText("角度PID")
        ...
        self.checkBoxLimits.setText("限制")
        ...
        self.sensorOffset.setText("传感器偏移")
        ...
        self.sensorElOffset.setToolTip('请小心！<br> 仅适用于绝对传感器')
        self.sensorElOffset.setText("传感器电气偏移")
