...
class SimpleFOCGraphicWidget(QtWidgets.QGroupBox):
    ...
    signals = ['目标值', 'Vq','Vd','Cq','Cd','速度','角度']
    signal_tooltip = ['目标值', '电压D [伏特]','电压D [伏特]','电流Q [毫安]','电流D [毫安]','速度 [弧度/秒]','角度 [弧度]']
...
class ControlPlotPanel(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None, controllerPlotWidget=None):
        ...
        self.zoomAllButton.setText('查看全部')
        ...
        self.downsampleLabel.setText('下采样')
