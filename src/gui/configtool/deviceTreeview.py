...
class DeviceTreeView(QTreeWidget):
    def __init__(self, parent=None):
        ...
        self.selectorTorque.addItems(['电压', '直流电流', 'FOC电流'])
        ...
        self.motionDownsample.setText(0, '运动下采样')
        ...
        self.PIDVelocityConfig = self.addPIDSubtree(self.motionControl,'速度PID')
        self.PIDAngleConfig = self.addPIDSubtree(self.motionControl,'角度PID')
        ...
        self.limitsConfig.setText(0, '限制')
        ...
        self.velocityLimit.setText(0, '速度限制')
        ...
        self.voltageLimit.setText(0, '电压限制')
        ...
        self.currentLimit.setText(0, '电流限制')
        ...
        self.satateTarget.setText(0, '目标值')
        ...
        self.sensorConfig.setText(0, '传感器配置')
        ...
        self.sensorZeroOffset.setText(0, '零角度偏移')
        ...
        self.sensorZeroElecOffset.setText(0, '电气零偏移')
        ...
        self.selectStatus.addItems(['禁用', '启用'])
        ...
        self.selectModulation.addItems(['正弦PWM', '空间矢量PWM', '梯形120度', '梯形150度'])
        ...
        self.customComands.setText(0, '自定义命令')
    ...
    def eventFilter(self, obj, event):
        if event.type() == QtCore.QEvent.KeyPress:
            ...
            if event.key() == QtCore.Qt.Key_Space or event.key() == QtCore.Qt.Key_Right:
                selectedItem = self.selectedItems()[0]
                if selectedItem.parent().text(0) == '自定义命令':
    ...
    def addPIDSubtree(self, parent,  label):
        ...
        proportionalGain.setText(0, '比例增益')
