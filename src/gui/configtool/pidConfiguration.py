...
class PidGroupBox(QtWidgets.QGroupBox):
    ...
    def __init__(self, parent=None):
        ...
        self.selectorPIDF.addItems(['速度', '角度', '电流Q', '电流D'])
